...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~DrRmxQyK#A6HXdJO6ilB15ucvcKPsmiMj9sYze9EKcdjffFtUPDI", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "2349068486092", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "2349068486092", // Only 1 owner Number Here, others Add to sudo numbers...
...
AUTO_BLOCK: process.env.AUTO_BLOCK || "false", // Add Multiple Country Codes Separated by Comma...
